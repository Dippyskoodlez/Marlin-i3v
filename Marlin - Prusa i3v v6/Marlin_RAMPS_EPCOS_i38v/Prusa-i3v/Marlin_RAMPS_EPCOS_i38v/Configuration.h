...
#define STRING_VERSION_CONFIG_H __DATE__ "  2-07-15 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Scott Billeg, i3v Prusa e3d v6)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,700}  // default steps per unit for ultimaker {78.7402,78.7402,200*8/3,760*1.1}920
